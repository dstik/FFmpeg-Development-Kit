...
sudo apt-get --quiet --yes install unzip zip
sudo apt-get --quiet --yes install automake cmake libsdl2-dev libtheora-dev libtool libva-dev libvdpau-dev libvorbis-dev libxcb1-dev libxcb-shm0-dev libxcb-xfixes0-dev mercurial texinfo wget
